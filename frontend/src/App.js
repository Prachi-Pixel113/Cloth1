      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-lg">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              <svg 
                className={`w-4 h-4 transition-colors ${isInWishlist(product.id) ? 'text-red-500 fill-red-500' : 'text-gray-600 hover:text-purple-600'}`} 
      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-3 right-3">
            ...
            >
              <svg 
                className={`w-4 h-4 transition-colors ${isInWishlist(product.id) ? 'text-red-500 fill-red-500' : 'text-gray-600 hover:text-pink-600'}`} 
                fill={isInWishlist(product.id) ? "currentColor" : "none"} 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-t-lg">
          ...
          <div className="absolute top-12 right-3">
            ...
            >
              <svg 
                className={`w-4 h-4 transition-colors ${isInWishlist(product.id) ? 'text-red-500 fill-red-500' : 'text-gray-600 hover:text-red-600'}`} 
                fill={isInWishlist(product.id) ? "currentColor" : "none"} 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-2 right-2">
          <button 
            onClick={handleWishlistToggle}
            className="bg-white rounded-full p-1 shadow-md hover:bg-pink-50"
          >
            <svg 
              className={`w-4 h-4 transition-colors ${isInWishlist(product.id) ? 'text-red-500 fill-red-500' : 'text-gray-600'}`} 
              fill={isInWishlist(product.id) ? "currentColor" : "none"} 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
